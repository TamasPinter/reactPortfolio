...
function AboutMe() {
  return (
    <div class="p-5 mb-4 bg-light container-fluid py-5">
      <h1 class="display-5 fw-bold text-center">About Tamas Pinter</h1>
      ...
      <p class="border border-dark border-2 shadow-sm p-3 mb-5 bg-body rounded">
          My name is Tamas (pronounced like Thomas) Pinter from Kitchener, Ontario! I am a full stack developer looking to
